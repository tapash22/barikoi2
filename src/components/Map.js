...
import { MapContainer, TileLayer, Marker, Popup,useMapEvents,Rectangle, CircleMarker, SVGOverlay,Polygon  } from "react-leaflet";
...
<SVGOverlay attributes={{ stroke: 'red' }} bounds={bounds}>
      <rect x="0" y="0" width="100%" height="100%" stroke="red" stroke-width="5" fill="green" />
